using hccShop.Application.Common;
...
namespace hccShop.Application.Catalog.Products
{
...

    {
        ...
        public ManageProductService(HccShopDbContext contex,IStorageService storageService)
        {
        ...
        public async Task<int> Update(ProductUpdateRequest request)
        {
            ...
            if (product == null || productTranslations == null) throw new HccShopException($"Cannot find a product with id: {request.Id}");
        ...
        {
            var product = await _context.Products.FindAsync(productId);
            if (product == null) throw new HccShopException($"Cannot find a product with id: {productId}");
